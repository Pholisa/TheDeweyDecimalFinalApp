...
namespace TheDeweyDecimalFinalApp
{
    public partial class FindingCallNumbers : Form
    {
        ...
        public void DataInTree()
        {
            ...
            label2.Text = $"What Dewey number falls under this {randomDescription.CatName} category?";

            foreach (var item in wrongCategories)
            {
                OptionsCheckListBox.Items.Add(item.DewyNum);
            }
        }
        ...
        public void DisplayNodeList(List<DewyNode> nodeList)
        {
            ...
            {
                Console.WriteLine($"Code: {node.DewyNum}, Name: {node.CatName}");
            }
        }
        ...
        private void btnCheckOne_Click(object sender, EventArgs e)
        {
            ...
            if (answer == randomCategory.DewyNum)
            {
            ...
            {
                MessageBox.Show($"You have selected the wrong match! The correct answer is  {randomCategory.DewyNum}!");
        ...
        {
            var answer = OptionsCheckListBox.CheckedItems[0].ToString();
            if (answer == randomSubcategory.DewyNum)
            {
                MessageBox.Show("Your answer is correct!!!");
                // Make the picture box visible
            ...
            {
                MessageBox.Show($"You have selected the wrong match! The correct answer is  {randomSubcategory.DewyNum}!");
        ...
        {
            var answer = OptionsCheckListBox.CheckedItems[0].ToString();
            if (answer == randomDescription.DewyNum)
            {
            ...
            {
                MessageBox.Show($"You have selected the wrong match! The correct answer is  {randomDescription.DewyNum}!");
